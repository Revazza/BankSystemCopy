...
public class AtmCashOutTests
{
    ...
    public async Task TestCashOutOperation()
    {
        ...
        var account = new AccountEntity { Amount = 10000, Currency = CurrencyType.GEL, UserId = user.Id };
        var request = new CashOutRequest { Amount = 1000, Currency = 0, RequestedCurrency = CurrencyType.GEL};
